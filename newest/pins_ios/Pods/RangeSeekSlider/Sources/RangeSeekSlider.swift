...
@IBDesignable open class RangeSeekSlider: UIControl {
    ...
    private func updateColors() {
        ...
        leftHandle.borderColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.04)
        leftHandle.borderWidth = 0.5
        leftHandle.shadowColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        leftHandle.shadowOpacity = 0.15
        leftHandle.shadowOffset = CGSize(width: 0, height: 3)
        leftHandle.shadowRadius = 8
        
        rightHandle.borderColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.04)
        rightHandle.borderWidth = 0.5
        rightHandle.shadowColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        rightHandle.shadowOpacity = 0.15
        rightHandle.shadowOffset = CGSize(width: 0, height: 3)
        rightHandle.shadowRadius = 8
    }
