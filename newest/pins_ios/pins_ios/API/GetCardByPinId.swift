//
//  GetCardByPinId.swift
//  pins_ios
//
//  Created by judongseok on 2021/09/26.
//

import UIKit

class GetCardByPinId {
    func requestGet(pinID: Int, pinType: String, completionHandler: @escaping (Bool, Any) -> Void) {
        ...
        let url = "http://bangi98.cafe24.com:8081/home/cardview?pinType=" + pinType +
