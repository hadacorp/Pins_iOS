...
class GetSearchKeywordPinApi {
    func requestGet(keyword: String, latitude: Double, longitude: Double, completionHandler: @escaping (Bool, Any) -> Void) {
        ...
        let url = "http://bangi98.cafe24.com:8081/home/search/pin?keyword=\(keyword)&latitude=\(latitude)&longitude=\(longitude)&meetingPinCategory=" + meetingPinCategory +
            "&meetDate=" + meetDate +
            "&meetTime=" + meetTime +
